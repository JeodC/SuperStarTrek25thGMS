...
function get_diff_text(diff_num) {
    switch (diff_num) {
        case 1: return lang_get("opt.diff1");
        case 2: return lang_get("opt.diff2");
        case 3: return lang_get("opt.diff3");
        case 4: return lang_get("opt.diff4");
...
function handle_warp_mode() {
    if (global.inputmode.mode == InputMode.Warp) {
        ...
        if (global.ent.condition != Condition.NoTime && global.ent.condition != Condition.Stranded) {
