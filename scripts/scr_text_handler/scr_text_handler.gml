...
function queue_dialog(speaker, line_id, voice_id = noone, format = undefined) {
    ...
    var dialog_closure = method({ dialog: dialog_line }, function() {
        return [dialog];
    });
...
function lang_get(key) {
    if (!is_struct(global.lang_data)) {
        show_debug_message("Error: global.lang_data is not a struct for key: " + key + ", lang: " + string(global.lang));
    ...
    show_debug_message("Error: Translation key not found: " + key + " in lang: " + global.lang);
    return normalize_text(key);
}

/// @description: Returns normalized translation for a key from global.lang_data and a variable to use for a given key
...
function normalize_text(str) {
    ...
    var map = {};
    map[$ string(ord("Á"))] = "A"; map[$ string(ord("á"))] = "a";
    map[$ string(ord("Č"))] = "C"; map[$ string(ord("č"))] = "c";
    map[$ string(ord("Ď"))] = "D"; map[$ string(ord("ď"))] = "d";
    map[$ string(ord("É"))] = "E"; map[$ string(ord("é"))] = "e";
    map[$ string(ord("Ě"))] = "E"; map[$ string(ord("ě"))] = "e";
    map[$ string(ord("Í"))] = "I"; map[$ string(ord("í"))] = "i";
    map[$ string(ord("Ň"))] = "N"; map[$ string(ord("ň"))] = "n";
    map[$ string(ord("Ó"))] = "O"; map[$ string(ord("ó"))] = "o";
    map[$ string(ord("Ř"))] = "R"; map[$ string(ord("ř"))] = "r";
    map[$ string(ord("Š"))] = "S"; map[$ string(ord("š"))] = "s";
    map[$ string(ord("Ť"))] = "T"; map[$ string(ord("ť"))] = "t";
    map[$ string(ord("Ú"))] = "U"; map[$ string(ord("ú"))] = "u";
    map[$ string(ord("Ů"))] = "U"; map[$ string(ord("ů"))] = "u";
    map[$ string(ord("Ý"))] = "Y"; map[$ string(ord("ý"))] = "y";
    map[$ string(ord("Ž"))] = "Z"; map[$ string(ord("ž"))] = "z";
    map[$ string(ord("À"))] = "A"; map[$ string(ord("à"))] = "a";
    map[$ string(ord("Â"))] = "A"; map[$ string(ord("â"))] = "a";
    map[$ string(ord("Ã"))] = "A"; map[$ string(ord("ã"))] = "a";
    map[$ string(ord("Ä"))] = "A"; map[$ string(ord("ä"))] = "a";
    map[$ string(ord("Ć"))] = "C"; map[$ string(ord("ć"))] = "c";
    map[$ string(ord("Ç"))] = "C"; map[$ string(ord("ç"))] = "c";
    map[$ string(ord("Đ"))] = "D"; map[$ string(ord("đ"))] = "d";
    map[$ string(ord("È"))] = "E"; map[$ string(ord("è"))] = "e";
    map[$ string(ord("Ê"))] = "E"; map[$ string(ord("ê"))] = "e";
    map[$ string(ord("Ë"))] = "E"; map[$ string(ord("ë"))] = "e";
    map[$ string(ord("Ì"))] = "I"; map[$ string(ord("ì"))] = "i";
    map[$ string(ord("Î"))] = "I"; map[$ string(ord("î"))] = "i";
    map[$ string(ord("Ï"))] = "I"; map[$ string(ord("ï"))] = "i";
    map[$ string(ord("Ñ"))] = "N"; map[$ string(ord("ñ"))] = "n";
    map[$ string(ord("Ò"))] = "O"; map[$ string(ord("ò"))] = "o";
    map[$ string(ord("Ô"))] = "O"; map[$ string(ord("ô"))] = "o";
    map[$ string(ord("Õ"))] = "O"; map[$ string(ord("õ"))] = "o";
    map[$ string(ord("Ö"))] = "O"; map[$ string(ord("ö"))] = "o";
    map[$ string(ord("Ś"))] = "S"; map[$ string(ord("ś"))] = "s";
    map[$ string(ord("Ş"))] = "S"; map[$ string(ord("ş"))] = "s";
    map[$ string(ord("Ţ"))] = "T"; map[$ string(ord("ţ"))] = "t";
    map[$ string(ord("Ù"))] = "U"; map[$ string(ord("ù"))] = "u";
    map[$ string(ord("Û"))] = "U"; map[$ string(ord("û"))] = "u";
    map[$ string(ord("Ü"))] = "U"; map[$ string(ord("ü"))] = "u";
    map[$ string(ord("Ÿ"))] = "Y"; map[$ string(ord("ÿ"))] = "y";
    map[$ string(ord("Ź"))] = "Z"; map[$ string(ord("ź"))] = "z";
    map[$ string(ord("Ż"))] = "Z"; map[$ string(ord("ż"))] = "z";
...
function get_keyname(action) {
    ...
    switch (source) {
        ...
        case InputSource.Gamepad:
            switch (action) {
                case "confirm": return "A Button";
                case "cancel":  return "B Button";
