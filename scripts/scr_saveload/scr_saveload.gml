...
function read_player_state(buf) {
  ...
  state.anim_lrs_state =
      has_lrs_state ? json_parse(buffer_read(buf, buffer_string)) : {};
  // Read anim_siren_state
  var has_siren_state = buffer_read(buf, buffer_bool);
  state.anim_siren_state =
      has_siren_state ? json_parse(buffer_read(buf, buffer_string)) : {};
